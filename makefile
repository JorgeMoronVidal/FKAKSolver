...
SRCS = test_elliptic_Sara.cpp BVP.cpp scalarfunction.cpp scalarfunctionN.cpp vectorfunction.cpp matrixfunction.cpp rbfunction.cpp boundary.cpp lookuptable.cpp sara.cpp rectangle.cpp FKAKsolver.cpp
