...
int main(){
    ...
    float rerr = 0.2f;
    params.push_back(0.0f); params.push_back(0.0f);
    params.push_back(3.0f);params.push_back(3.0f);
    BVP bvp;
    ...
    FILE *fp;
    fp = fopen("Output/ellipticGM_test_Sara.txt", "w");
    FKAKSolver Solver[8];
    ...
    PRINTF2(fp,"**********************************************************\n");
    PRINTF2(fp,"\n");
    PRINTF2(fp,"*************Gobet Menozzi Integrator**************************\n");
    PRINTF2(fp,"*** Convergence tests ************************************\n");
    PRINTF2(fp,"****Sara Smooth equation**************************************\n");
